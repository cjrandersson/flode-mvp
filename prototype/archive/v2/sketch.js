...
function drawMainWindow(){
  ...
  fill(C.text3);textSize(S(8.5));text('six-pod sampler / probability instrument',x+S(64),y+S(17));
...
function drawFooter(){fill(C.text3);noStroke();textSize(S(6.8));textAlign(LEFT,BOTTOM);text('SHIFT + drag = precision   •   CTRL + wheel = waveform zoom   •   drag amber loop handles   •   click transient markers   •   drop audio on waveform',S(38),height-S(5));textAlign(LEFT,BASELINE)}
